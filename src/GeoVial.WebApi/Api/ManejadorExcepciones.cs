...
public sealed class ManejadorExcepciones(IProblemDetailsService problemDetailsService) : IExceptionHandler
{
    ...
    private static (int Status, string Codigo) Mapear(Exception ex) => ex switch
    {
        ...
        RelevamientoFueraDeAmbitoException e => (StatusCodes.Status403Forbidden, e.Codigo),
        RolNoAutorizadoException e => (StatusCodes.Status403Forbidden, e.Codigo),
        SubidaNoConcluidaException e => (StatusCodes.Status409Conflict, e.Codigo),
        FotoNoRecuperableException e => (StatusCodes.Status409Conflict, e.Codigo),
        ...
        ConflictoNoEncontradoException e => (StatusCodes.Status404NotFound, e.Codigo),
        ...
        RelevamientoNoEnRevisionException e => (StatusCodes.Status409Conflict, e.Codigo),
        ConflictosPendientesException e => (StatusCodes.Status409Conflict, e.Codigo),
        MarcadorConObservacionesException e => (StatusCodes.Status409Conflict, e.Codigo),
        EtiquetaYaExisteException e => (StatusCodes.Status409Conflict, e.Codigo),
